...
<link href='styleWorkFigure.css' rel='stylesheet' type='text/css'>

<jsp:useBean id="selectedPlock" scope="request" class="beans.Plock" />
<jsp:useBean id="splitPlock" scope="request" class="java.util.ArrayList" />
<jsp:setProperty name="selectedPlock" property="*" />
<jsp:setProperty name="splitPlock" property="*" />
...
/* Small viewports â Old monitors, netbooks, tablets (landscape), etc. */
...
/* Smaller viewports â more tablets, old monitors */
...
/* Even smaller viewports â more tablets, etc. */
...
<%!
  int blockTypeNumber = 12;
  //TODO: details로 바로 접속하는 경우에 대한 대처 필요
  //System.out.println("details for " + selectedPlock.getTitle());
%>
    ...
    <div class="container object">
      ...
      <div id="main-container-image">
        ...
        <div class="title-item">
          ...
          <div class="title-text">${selectedPlock.getTitle()}</div>
          <div class="title-text-2">${selectedPlock.getC_date()}</div>
        </div>


            <div id="wrapper-part-info">
              <div class="part-info-image-single">
                <img onerror="javascript:src='img/noimg.png'" src="${selectedPlock.getImage_url()}" alt="" width="628" height="437" />
                <hr>
              </div>
              
              <%-- plock --%>
              <div class="part-info-image-single">
              <div class="part-info-plock">

<%
int[] blockCount = new int[blockTypeNumber+1];

//each type block counting (갯수)
for(int i=0; i<splitPlock.size(); i++) {
    blockCount[((BlockData) splitPlock.get(i)).getType()]++;
}

for(int i=0; i<blockCount.length; i++) {
  //out.println(blockCount[i]);
  if(blockCount[i] != 0) {
    out.println("<div class='work'> <figure class='white'>");
    out.println("<img src='imgBlock/"+i+".PNG' alt='' onerror=''/>");
    out.println("<div class='thank-text'>"+blockCount[i]+"</div>");
    out.println("</figure> </div>");
  }
}
%>
                
              <%--
              <c:forEach var="eachBlock" items="${blockCount}" varStatus="status">
                <img src="img/${eachBlock}.PNG" alt="" onerror=""/>
                <c:choose>
                  <c:when test="${eachBlock.getType() eq '1'}">
                  </c:when>
                </c:choose>
              </c:forEach>
              --%>
          ...
          <div class="wrapper-text-description">
            ...
            <div class="wrapper-view">
              ...
              <div class="text-view">${selectedPlock.getViews()} views</div>
            </div>
            ...
            <div class="wrapper-file">
              ...
              <div class="text-file">${selectedPlock.getCategory()} category</div>
            </div>
            ...
            <div class="wrapper-weight">
              ...
              <div class="text-weight">${selectedPlock.getDown_num()} downloads</div>
            </div>
            ...
            <div class="wrapper-desc">
              ...
              <div class="text-desc">description | ${selectedPlock.getDescription()}</div>
            </div>
...
<!-- 
            <div class="wrapper-morefrom">
              <div class="text-morefrom">More from this categories</div>
...
<!-- 
          <div class="post-reply">
            ...
            <div class="name-reply-post">댓글맨 1</div>
            <div class="text-reply-post">Awesome! Thank you a lot.</div>
          </div>
 ...
 -->
    ...
    <div id="wrapper-thank">
      <div class="thank">
        <div class="thank-text">plock</div>
      </div>
    </div>
      ...
      <div class="container-footer">
        ...
        <div id="row-1f">
          <div class="text-row-1f">
            <span style="font-weight: 600; font-size: 15px; color: #666; line-height: 250%; text-transform: uppercase; letter-spacing: 1.5px;">What is Burstfly</span><br>Burstfly is just a blog
            showcasing hand-picked free themes, design stuff, free fonts and other resources for web designers.
          </div>
        </div>

        <div id="row-2f">
          <div class="text-row-2f">
            <span style="font-weight: 600; font-size: 15px; color: #666; line-height: 250%; text-transform: uppercase; letter-spacing: 1.5px;">How does it work</span><br>Burstfly offers you all the
            latest freebies found all over the fourth corners without to pay.
          </div>
        </div>
    ...
    <div id="wrapper-copyright">
      <div class="copyright">
        <div class="copy-text object">
          Copyright © 2016. Template by <a style="color: #D0D1D4; font-weight: bold;" href="https://dcrazed.com/">
          Dcrazed</a> Powered by <a style="color: #D0D1D4; font-weight: bold;">Letsgo</a>
        </div>
  ...
  <script>
    ...
    $(document).on('touchstart mouseover', '#wrapper-title-2',
        function(event) {
    ...
    $(document).on('touchend mouseout', '#wrapper-title-2',
        function(event) {
    ...
    $(document).on('touchstart mouseover', '#wrapper-title-3',
        function(event) {
    ...
    $(document).on('touchend mouseout', '#wrapper-title-3',
        function(event) {
    ...
    $("form").on(
        ...
        function(event) {
          event.preventDefault();
          $.post("/burstfly/form-burstfly-modified.asp", $("form")
              .serialize(), function(data) {//alert(data);
          });
        });
  </script>
